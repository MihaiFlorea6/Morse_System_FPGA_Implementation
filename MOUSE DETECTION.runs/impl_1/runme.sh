...
HD_PWD='C:/Users/Mihai Florea/MOUSE DETECTION/MOUSE DETECTION.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_recognizer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source morse_recognizer_top.tcl -notrace
