...
HD_PWD='C:/Users/Mihai Florea/MOUSE DETECTION/MOUSE DETECTION.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_recognizer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source morse_recognizer_top.tcl
